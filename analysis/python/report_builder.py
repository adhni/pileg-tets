...
<body>
  <div class="wrap">
    ...
    <section class="section">
      ...
      <div class="metric-grid">
        {metric_card("Estimated Seats", str(winners["total_seats"]), "Total seats allocated with explicit dapil seat counts")}
        {metric_card("Winning Parties", str(winners["parties_winning_seats"]), "Parties winning at least one seat")}
      ...
      <div class="two-col">
        <div>
          <h3>Estimated Seats By Party</h3>
          {html_table(seats_by_party, ["party_code", "estimated_seats"], 10)}
...
"""
    ...
    markdown = "\n\n".join(
        [
            ...
            f"- Winning parties: {winners['parties_winning_seats']}",
